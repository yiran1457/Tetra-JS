...
public class CrossBowModularItem extends ModularCrossbowItem implements ITetraJSItem {
    ...
    public CrossBowModularItem(ResourceLocation itemID, List<SlotData> majorsData, List<SlotData> minorsData, boolean canHone, int honeBase, int honeIntegrityMultiplier, String[] synergiesPath) {
        super(Items.ARROW);
